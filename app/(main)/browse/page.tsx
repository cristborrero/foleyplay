  ...
  return (
    <div className="w-full">
      ...
      <div className="-mt-16 sm:-mt-24 md:-mt-32 lg:-mt-40 relative z-20">
        <UserContentRow title="Continuar viendo" fetchUrl="/api/history" showProgress />
        <UserContentRow title="Mi Lista" fetchUrl="/api/watchlist" />

        <ContentRow title="Tendencias Actuales" fetchUrl="/api/tmdb/trending/all/day" isLargeRow />
        <ContentRow title="Películas Populares" fetchUrl="/api/tmdb/movie/popular" mediaType="movie" />
        <ContentRow title="Series Populares" fetchUrl="/api/tmdb/tv/popular" mediaType="tv" />
        ...
        <ContentRow title="Series de Acción y Aventura" fetchUrl="/api/tmdb/discover/tv?with_genres=10759" mediaType="tv" />
        <ContentRow title="Series de Comedia" fetchUrl="/api/tmdb/discover/tv?with_genres=35" mediaType="tv" />
        <ContentRow title="Series de Drama" fetchUrl="/api/tmdb/discover/tv?with_genres=18" mediaType="tv" />
