  ...
  return (
    <div className="flex space-x-4 mt-4">
      <button 
        ...
        className="bg-white text-black font-bold py-2 px-6 rounded flex items-center hover:bg-gray-200 transition-colors"
      >
      ...
      <button 
        ...
        disabled={isLoading}
        className="bg-[#333] text-white font-bold py-2 px-6 rounded flex items-center hover:bg-[#444] transition-colors disabled:opacity-50"
      >
        {inWatchlist ? (
          <>
